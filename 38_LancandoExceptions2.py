...
if __name__ == '__main__':
    ...
    conta_corrente1 = ContaCorrente(None, 400, 1234567)
        ...
        ### ValueError: ('O atributo agencia deve ser um inteiro', 400.5)

        ### COM O PARAMETRO AGENCIA NEGATIVO = -400
        ### ValueError: O atributo agencia deve ser maior que zero

        ### OBS - O PARAMETRO NUMERO DE CONTA POSSUI OS MESMOS TRATAMENTOS
        ### NUMERO DA CONTA TEM QUE SER INTEIRO E MAIOR QUE ZERO
    ...
    conta_corrente1.sacar(100)
        ...
        ### SaldoInsuficienteError: Saldo insuficiente para efetuar uma transação 
        ### Saldo atual: 100. Valor a ser sacado: 1000
    ...
    conta_corrente2.depositar(100)
        ...
        ### DEPOSITO COM VALOR NEGATIVO -100
        ### OperacaoFinanceiraError: Operação não finalizada
    ...
    conta_corrente2.transferir(200, conta_corrente1)
        ...
        ### TENTANDO TRANSFERENCIA NUM VALOR MAIOR QUE SALDO 500
        ### OperacaoFinanceiraError: Operação não finalizada
